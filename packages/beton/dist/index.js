...
var buttonStyles2 = classVarianceAuthority.cva("flex items-center justify-center px-4 py-2 rounded font-medium focus:outline-none focus:ring-2 focus:ring-offset-white dark:focus:ring-offset-black focus:ring-offset-1 disabled:opacity-60 disabled:pointer-events-none hover:bg-opacity-80", {
    variants: {
        intent: {
...
function Button2(_a) {
    ...
    return jsxRuntime.jsx("button", __assign({ className: buttonStyles2({ intent: intent, fullWidth: fullWidth }) }, props));
}
